...
const teamDivisions = {
  ...
  acara: {
    ...
    members: [
      ...
      { name: "Ikhsan maulana", role: "Anggota Acara", instagram: "username" },
      { name: "Lucky Lumansyah", role: "Anggota Acara", instagram: "username" },
      { name: "Anatasia Vinka", role: "Anggota Acara", instagram: "username" },
      { name: "Pasha fadhilah", role: "Anggota Acara", instagram: "username" },
    ],
  },
  konsumsi: {
    label: "Konsumsi",
    members: [
      ...
      { name: "Jovanka Putri", role: "andhika hikmah maulid", instagram: "dikcharito", photo: "assets/images/team/andika-konsumsi.jpg"},
      { name: "Anita Khofsah", role: "Anggota Konsumsi", instagram: "username", },
      { name: "Andhika Hikmah", role: "Anggota Konsumsi", instagram: "username", },
    ],
  },
  humas: {
    label: "Humas",
  ...
  pdd: {
    ...
    members: [
      ...
      { name: "Zahra Salsabila", role: "Anggota PDD", instagram: "username" },
      { name: "Adelia malika", role: "Anggota PDD", instagram: "username" },
      { name: "Muhammad Rizal", role: "Anggota PDD", instagram: "username" },
      { name: "Ihsan Lumanul", role: "Anggota PDD", instagram: "username" },
      { name: "Danuarkha", role: "Anggota PDD", instagram: "username" },
    ],
  },
};
